...
View(table1014_2_flip)
```

```{r}
colnames(table1014_2_flip)[1] <- 'Totals'
colnames(table1014_2_flip)[2] <- 'All prisoners'
colnames(table1014_2_flip)[3] <- 'Male'
colnames(table1014_2_flip)[3] <- 'Female'
colnames(table1014_2_flip)[4] <- 'White/b'
colnames(table1014_2_flip)[5] <- 'Black/b'
colnames(table1014_2_flip)[6] <- 'Hispanic'
table1014_2_flip
